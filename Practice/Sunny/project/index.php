...
<a href="#" class="pull-right btn sub1" style="border-radius:2%" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<span class="title1" id="userLogin"><b>Login</b></span></a></div>
<!--sign in modal start-->
...
<p class="text-center"><b>Register As Student</b></p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Sunny Kumar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 123456789</h4>
		<h4 style="font-family:'typo' ">sunnyfromiitg@gmail.com</h4>
		<h4 style="font-family:'typo' ">Indian Institute of Technology Guwahati, Assam</h4></div></div>
		</p>
      </div>
